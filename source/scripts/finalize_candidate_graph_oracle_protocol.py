...
DEFAULT_CONFIG = REPO_ROOT / "configs/candidate_graph_oracle_ceiling_v3.json"
...
EXPECTED_CODE_PIN_PAIRS: tuple[tuple[str, str, str], ...] = (
    (
        "evaluator_path",
        "evaluator_sha256",
        "scripts/evaluate_candidate_graph_oracle.py",
    ),
    ("tests_path", "tests_sha256", "tests/test_candidate_graph_oracle.py"),
    (
        "fixture_builder_path",
        "fixture_builder_sha256",
        "scripts/build_candidate_graph_oracle_fixtures.py",
    ),
    (
        "fixture_builder_tests_path",
        "fixture_builder_tests_sha256",
        "tests/test_build_candidate_graph_oracle_fixtures.py",
    ),
    (
        "pin_finalizer_path",
    ...
    (
        ...
        "scripts/update_candidate_graph_oracle_ledger.py",
    ),
    (
    ...
    (
        ...
        "scripts/push_candidate_graph_oracle_phase_a.py",
    ),
    (
        "phase_b_runner_path",
        "phase_b_runner_sha256",
        "scripts/run_candidate_graph_oracle_phase_b.py",
    ),
)
