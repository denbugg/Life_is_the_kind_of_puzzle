...
EXPECTED_CONFIG = REPO_ROOT / "configs/candidate_graph_oracle_ceiling_v3.json"
...
PINNED_REPO_READ_FILES = (
    ...
    "tests/test_candidate_graph_oracle.py",
...
KNOWN_CODE_ALLOWLIST = frozenset(
    value for value in PINNED_REPO_READ_FILES if value.startswith("src/")
)
