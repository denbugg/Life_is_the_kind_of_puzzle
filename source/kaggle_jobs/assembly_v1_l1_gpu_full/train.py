...
initializers = sorted(input_root.rglob("l1_local_512x1_cont.pt"))
...
command = [
    ...
    "--device", "cuda",
    "--data-parallel",
    "--output", "/kaggle/working/l1_gpu_full.pt",
]
...
result = {
    "schema_version": 1,
    "kind": "assembly_v1_l1_gpu_full_wrapper",
    "probe": probe,
    "seconds": time.time() - started,
    "training_report": "/kaggle/working/l1_gpu_full.json",
}
