...
OWNER = "pasha883"
CODE_SLUG = "vsos-candidate-graph-oracle-code"
INPUT_SLUG = "vsos-candidate-graph-oracle-inputs"
RUNTIME_SLUG = "vsos-candidate-graph-oracle-runtime"
CONFIG_RELATIVE = Path("configs/candidate_graph_oracle_ceiling_v1.json")
...
OUTPUT_ROOT = Path("/kaggle/working/candidate_graph_oracle_phase_a")
WRAPPER_PATH = Path("/kaggle/working/candidate_graph_oracle_phase_a_wrapper.json")
...
expected_launch = {
    "kernel_id": 126834780,
    "kernel_slug": f"{OWNER}/vsos-candidate-graph-oracle-phase-a-t4x2",
    "kernel_version": 2,
    "dataset_versions": {
...
wrapper = {
    ...
    "kernel_slug": "pasha883/vsos-candidate-graph-oracle-phase-a-t4x2",
