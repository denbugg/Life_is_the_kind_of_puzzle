...
OUTPUT_ROOT = Path("/kaggle/working/candidate_graph_oracle_v3_phase_a")
WRAPPER_PATH = Path("/kaggle/working/candidate_graph_oracle_v3_phase_a_wrapper.json")
...
expected_launch = {
    "kernel_id": 126846203,
    "kernel_slug": f"{OWNER}/vsos-candidate-graph-oracle-v3-phase-a-t4x2",
    "kernel_version": 2,
    "dataset_versions": {
