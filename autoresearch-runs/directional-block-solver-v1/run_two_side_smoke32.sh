...
mkdir -p two_side_smoke32
export SOLVER_METHODS=baseline,block2,two_side,two_side_block2
/home/kva/pazzle_directional_transformer/.venv/bin/python \
  ...
  --output two_side_smoke32/metrics.json \
  --limit 32 \
  > two_side_smoke32/eval.log 2>&1
