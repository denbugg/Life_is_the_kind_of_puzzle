...
| 1 | 23 | frozen I21 residual K64 over exact E22 prefix | eligible recall 0.970505 mean / 0.907640 worst | +0.056432 mean over matched null; 8/8 wins | 30/30 gates, efficiency 1.996x, coverage 0.909505/0.843750, exact replay; confirmation only |
...
- all-emitter RCCE-4 over the unchanged K64+K64 affinity union: singleton connectivity was solved (398.5 exact connected tiles mean; coverage 0.691840/0.302083 mean/worst; cycle ratio 0.440489/0.255435; exact filter survival 5063/5063), but eligible pair recall was only 0.717756 mean and 0.600912 worst versus 0.90/0.80; this exact affinity-only generator is closed without resweep, and the remaining bottleneck is missing candidate pairs rather than geometry or oracle connectivity
...
- E22 proves all-emitter lifting and exact geometry are sufficient for large oracle clusters, but the existing affinity union still misses roughly 28% of eligible contacts on average; add exactly one orthogonal, predeclared candidate source and require the same survival/connectivity gates before any verifier training
- E23 solves that discovery-set candidate-recall bottleneck: frozen I21 residual K64 reaches 0.970505/0.907640 mean/worst recall, beats a matched dense null on 8/8 with +0.056432 mean lift and 1.996x efficiency, and connects 523.875 tiles on average; next run the identical frozen generator on a source-group-disjoint confirmation set, not a K/checkpoint/null resweep
