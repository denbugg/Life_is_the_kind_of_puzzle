#!/usr/bin/env python3
"""Independently recompute the fixed-B pipeline for every submitted board."""
...
from aiijc_puzzle.compliant_fixed_b_standard_validation import validate_submission
